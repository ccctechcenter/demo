...
-- SOURCE  : enUS
-- TARGET  : I18N
-- DATE    : Tue Mar 12 12:23:11 2013
-- MSGSIGN : #ac5e76bc467c1102
--TMI18N.ETR DO NOT CHANGE--
--
-- FILE NAME..: bwckcom1.sql
-- RELEASE....: 8.5.3[C3SC 8.7]
-- OBJECT NAME: BWCKCOMS
-- PRODUCT....: SCOMWEB
-- COPYRIGHT..: Copyright 2002 - 2014 Ellucian Company L.P. and its affiliates.
--

   curr_release   CONSTANT VARCHAR2 (30)             := '8.5.3[C3SC 8.7]';
...
-- =====================================================================
   ...
   BEGIN
      ...
      lv_literal(1) :=         g$_nls.get ('BWCKCOM1-0019',
                                           'SQL',
                                           'Submit Changes');
      lv_literal(2) :=         g$_nls.get ('BWCKCOM1-0020',
                                           'SQL',
                                           'Register');
      lv_literal(3) :=         g$_nls.get ('BWCKCOM1-0021',
                                          'SQL',
 -- 8.5.1
 --                                         'Class Search');
                                            'New Search');
...
-- Study Path Changes
         ...
         end_date_out (1) := 'dummy';
         btn (1) := 'dummy';
         btn (2) := g$_nls.get ('BWCKCOM1-0022', 'SQL', 'Submit Changes');
         BEGIN
      ...
      ELSIF LTRIM (RTRIM (add_btn (2))) IN
               (
                  g$_nls.get ('BWCKCOM1-0023', 'SQL', 'Add to WorkSheet'),
                  g$_nls.get ('BWCKCOM1-0024', 'SQL', 'Back to WorkSheet')
               )
      THEN
         bwckcoms.p_adddrop1 (
            term_in,
         ...
         if f_subg_crse_selected(genpidm, assoc_term (i), crn (i) ) then
           --htp.p('inside the true condition ++++'||genpidm ||' '||assoc_term (i)|| '  '|| '  '||crn (i));
            ...
            -- record the courses in violation
               ...
               bwckregs.p_getsection (assoc_term (i), crn (i), subg_subj (f), subg_crse (f), subg_sec (f));
      ...
      ELSE
         ...
         twbkfrmt.p_tabledatalabel (
            twbkfrmt.f_formlabel (
               G$_NLS.Get ('BWCKCOM1-0029', 'SQL', 'Student ') ||
               '<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0030', 'SQL', 'Personal Identification Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0031', 'SQL', 'PIN') ||
               '</ACRONYM>' || ':',
               idname   => 'student_pin'
            )
         );
...
BEGIN
  ...
  ELSE
    lv_return_val := (g$_nls.get('BWCKCOM1-0032', 'SQL', 'None'));
  END IF;
...
-- ==================================================
         ...
         twbkfrmt.p_printheader (
            '3',
            g$_nls.get ('BWCKCOM1-0038', 'SQL', 'Current Schedule')
         );
         twbkfrmt.p_tableopen (
            'DATADISPLAY',
            cattributes   => 'SUMMARY="' ||
         ...
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0040', 'SQL', 'Status')
         );
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0041', 'SQL', 'Action')
         );

         IF multi_term_in
         THEN
            twbkfrmt.p_tabledataheader (
               g$_nls.get ('BWCKCOM1-0042', 'SQL', 'Associated Term')
            );
         END IF;
         ...
         twbkfrmt.p_tabledataheader (
            twbkfrmt.f_printtext (
               '<ACRONYM title = "' ||
                  ...
                  '">' ||
                  g$_nls.get ('BWCKCOM1-0044', 'SQL', 'CRN') ||
                  '</ACRONYM>'
            )
         );
         twbkfrmt.p_tabledataheader (
            twbkfrmt.f_printtext (
               '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0045',
                                      'SQL',
                                      'Subject') ||
                  '>' ||
                  g$_nls.get ('BWCKCOM1-0046', 'SQL', 'Subj') ||
                  '</ABBR>'
            )
         );
         twbkfrmt.p_tabledataheader (
            twbkfrmt.f_printtext (
               '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0047', 'SQL', 'Course') ||
                  '>' ||
                  g$_nls.get ('BWCKCOM1-0048', 'SQL', 'Crse') ||
                  '</ABBR>'
            )
         );
         twbkfrmt.p_tabledataheader (
         ...
         twbkfrmt.p_tabledataheader (
            twbkfrmt.f_printtext (
               '<ABBR title = "' ||
                  g$_nls.get ('BWCKCOM1-0052', 'SQL', 'Credit Hours') ||
                  '">' ||
                  g$_nls.get ('BWCKCOM1-0053', 'SQL', 'Cred') ||
                  '</ABBR>'
            )
         );
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0054', 'SQL', 'Grade Mode')
         );
         twbkfrmt.p_tabledataheader (g$_nls.get ('BWCKCOM1-0055', 'SQL', 'Title'));
-- SP changes
        IF bwckcoms.F_StudyPathEnabled  = 'Y' THEN
          twbkfrmt.p_tabledataheader (g$_nls.get ('BWCKCOM1-0056', 'SQL', 'Study Path'));
        END IF;
-- SP changes
         twbkfrmt.p_tablerowclose;
...
-- ==================================================
   ...
   BEGIN
      ...
      THEN
         ...
         twbkfrmt.p_tablerowopen;
         twbkfrmt.p_tabledata (
            g$_nls.get ('BWCKCOM1-0058', 'SQL', 'Total Credit Hours') || ': '
         );
         twbkfrmt.p_tabledata (
         ...
         twbkfrmt.p_tablerowopen;
         twbkfrmt.p_tabledata (
            g$_nls.get ('BWCKCOM1-0059', 'SQL', 'Billing Hours') || ':'
         );
         twbkfrmt.p_tabledata (
         ...
         THEN
            ...
            twbkfrmt.p_tabledata (
               twbkfrmt.f_printtext (
                  '<ACRONYM title = "' ||
                     g$_nls.get ('BWCKCOM1-0060',
                        'SQL',
                        'Continuing Education Units') ||
                     '">' ||
                     g$_nls.get ('BWCKCOM1-0061', 'SQL', 'CEU') ||
                     '</ACRONYM>:'
               )
            );
            twbkfrmt.p_tabledata (
         ...
         LOOP
            ...
            twbkfrmt.p_tabledata (
               g$_nls.get ('BWCKCOM1-0062', 'SQL', 'Minimum Hours') || ':'
            );
            ...
            twbkfrmt.p_tabledata (
               g$_nls.get ('BWCKCOM1-0063', 'SQL', 'Maximum Hours') || ':'
            );
...
-- =====================================================================
   ...
   BEGIN
      twbkfrmt.p_printmessage (
         g$_nls.get ('BWCKCOM1-0065', 'SQL', 'Registration Add Errors'),
         'ERROR'
      );
      twbkfrmt.p_tableopen (
         'DATADISPLAY',
      ...
      twbkfrmt.p_tablerowopen;
      twbkfrmt.p_tabledataheader (g$_nls.get ('BWCKCOM1-0067', 'SQL', 'Status'));

      IF call_type = 1
      THEN
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0068', 'SQL', 'Action')
         );
      END IF;
      ...
      THEN
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0069', 'SQL', 'Associated Term')
         );
      END IF;
      ...
      twbkfrmt.p_tabledataheader (
         twbkfrmt.f_printtext (
            '<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0070', 'SQL', 'Course Reference Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0071', 'SQL', 'CRN') ||
               '</ACRONYM>'
         )
      );
      twbkfrmt.p_tabledataheader (
         twbkfrmt.f_printtext (
            '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0072', 'SQL', 'Subject') ||
               '>' ||
               g$_nls.get ('BWCKCOM1-0073', 'SQL', 'Subj') ||
               '</ABBR>'
         )
      );
      twbkfrmt.p_tabledataheader (
         twbkfrmt.f_printtext (
            '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0074', 'SQL', 'Course') ||
               '>' ||
               g$_nls.get ('BWCKCOM1-0075', 'SQL', 'Crse') ||
               '</ABBR>'
         )
      );
      twbkfrmt.p_tabledataheader (
      ...
      twbkfrmt.p_tabledataheader (
         twbkfrmt.f_printtext (
            '<ABBR title = "' ||
               g$_nls.get ('BWCKCOM1-0079', 'SQL', 'Credit Hours') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0080', 'SQL', 'Cred') ||
               '</ABBR>'
         )
      );
      twbkfrmt.p_tabledataheader (
         g$_nls.get ('BWCKCOM1-0081', 'SQL', 'Grade Mode')
      );
      twbkfrmt.p_tabledataheader (g$_nls.get ('BWCKCOM1-0082', 'SQL', 'Title'));
      -- SP changes
        IF bwckcoms.F_StudyPathEnabled  = 'Y' THEN
          twbkfrmt.p_tabledataheader (g$_nls.get ('BWCKCOM1-0083', 'SQL', 'Study Path'));
        END IF;
-- SP changes
      twbkfrmt.p_tablerowclose;
...
--  Display info about the study path chosen
        ...
        IF (twbkwbis.f_getparam (global_pidm, 'G_SP_SET') IS NOT NULL) THEN
          IF  (twbkwbis.f_getparam (global_pidm, 'G_SPATH') IS NOT NULL) THEN
            ...
            twbkfrmt.p_printheader
                     (
                     '4',
                     g$_nls.get ('BWCKCOM1-0085', 'SQL', 'Selected Study Path is %01%',lv_sp_name
                                )
                    );
          ELSE
    ...
    END IF;
      ...
      twbkfrmt.p_tableheader (
         twbkfrmt.f_printtext (
            '<ACRONYM title = "' ||
            g$_nls.get ('BWCKCOM1-0087', 'SQL', 'Course Reference Numbers') ||
            '">' ||
            g$_nls.get ('BWCKCOM1-0088', 'SQL', 'CRNs') ||
            '</ACRONYM>'
         ),
      ...
      LOOP
         ...
         twbkfrmt.p_formlabel (
            g$_nls.get ('BWCKCOM1-0089', 'SQL', 'CRN'),
            visible   => 'INVISIBLE',
            idname    => 'crn_id' || TO_CHAR (i)
         );
         twbkfrmt.p_formtext (
...
-- =====================================================================
   ...
   BEGIN
      ...
      THEN
         HTP.formsubmit (
            'REG_BTN',
            g$_nls.get ('BWCKCOM1-0091', 'SQL', 'Class Search')
         );
      END IF;
      ...
      IF bwckcoms.F_StudyPathEnabled = 'Y' and NVL(multi_term,'N') <> 'Y' THEN
        HTP.formsubmit (
            'REG_BTN',
            g$_nls.get ('BWCKCOM1-0093', 'SQL', 'Select Study Path')
         );
      END IF;
   END p_add_drop_crn2;
      ...
      CASE substr(msg_in,1,1)
         WHEN '1' THEN
            twbkfrmt.p_printmessage ('<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0094', 'SQL', 'Course Reference Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0095', 'SQL', 'CRN') ||
               '</ACRONYM> ' ||
               G$_NLS.Get ('BWCKCOM1-0096', 'SQL',
         ...
         WHEN '2' THEN
            twbkfrmt.p_printmessage ('<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0097', 'SQL', 'Course Reference Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0098', 'SQL', 'CRN') ||
               '</ACRONYM> ' ||
               G$_NLS.Get ('BWCKCOM1-0099','SQL',
                  '%01%, date entered (%02%) is invalid.',
                  crn_in (to_number(substr(msg_in,2))),
         ...
         WHEN '3' THEN
            twbkfrmt.p_printmessage ('<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0100', 'SQL', 'Course Reference Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0101', 'SQL', 'CRN') ||
               '</ACRONYM> ' ||
               G$_NLS.Get ('BWCKCOM1-0102', 'SQL',
                  '%01%, only one of start or end dates may be entered.',
                  crn_in (to_number(substr(msg_in,2)))),
               'ERROR');
         WHEN '4' THEN
            twbkfrmt.p_printmessage ('<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0103', 'SQL', 'Course Reference Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0104', 'SQL', 'CRN') ||
               '</ACRONYM> ' ||
               G$_NLS.Get ('BWCKCOM1-0105', 'SQL',
         ...
         WHEN '5' THEN
            twbkfrmt.p_printmessage ('<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0106', 'SQL', 'Course Reference Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0107', 'SQL', 'CRN') ||
               '</ACRONYM> ' ||
               G$_NLS.Get ('BWCKCOM1-0108', 'SQL',
         ...
         WHEN '6' THEN
            twbkfrmt.p_printmessage ('<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0109', 'SQL', 'Course Reference Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0110', 'SQL', 'CRN') ||
               '</ACRONYM> ' ||
               G$_NLS.Get ('BWCKCOM1-0111', 'SQL',
         ...
         WHEN '7' THEN
            twbkfrmt.p_printmessage ('<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0112', 'SQL', 'Course Reference Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0113', 'SQL', 'CRN') ||
               '</ACRONYM> ' ||
               G$_NLS.Get ('BWCKCOM1-0114', 'SQL',
         ...
         ELSE
            twbkfrmt.p_printmessage ('<ACRONYM title = "' ||
               g$_nls.get ('BWCKCOM1-0115', 'SQL', 'Course Reference Number') ||
               '">' ||
               g$_nls.get ('BWCKCOM1-0116', 'SQL', 'CRN') ||
               '</ACRONYM> ' ||
               G$_NLS.Get ('BWCKCOM1-0117', 'SQL', '%01%, start or end date must be entered.',
                  crn_in (to_number(substr(msg_in,2)))),
            'ERROR');
      END CASE;
...
-- =================================================
      ...
      THEN
         ...
         twbkfrmt.p_tabledataheader (
            twbkfrmt.f_printtext (
               '<ACRONYM title = "' ||
                  g$_nls.get ('BWCKCOM1-0119', 'SQL', 'Course Reference Number') ||
                  '">' ||
                  g$_nls.get ('BWCKCOM1-0120', 'SQL', 'CRN') ||
                  '</ACRONYM>'
            )
         );
         ...
         THEN
            twbkfrmt.p_tabledataheader (
               g$_nls.get ('BWCKCOM1-0121', 'SQL', 'Associated Term')
            );
         END IF;

         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0122', 'SQL', 'Course')
         );
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0123', 'SQL', 'Course Title')
         );
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0124', 'SQL', 'Duration')
         );
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0125',
               'SQL',
               'Start Date (%01%)',
         ...
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0127', 'SQL', 'Permitted Start Dates')
         );
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0128', 'SQL', 'Permitted End Dates')
         );
         twbkfrmt.p_tablerowclose;
      END IF;
...
-- =================================================
               twbkfrmt.p_tabledataopen;
               twbkfrmt.p_formlabel (
                  g$_nls.get ('BWCKCOM1-0129', 'SQL', 'Start'),
                  visible   => 'INVISIBLE',
               ...
               twbkfrmt.p_tabledataopen;
               twbkfrmt.p_formlabel (
                  g$_nls.get ('BWCKCOM1-0130', 'SQL', 'End'),
                  visible   => 'INVISIBLE',
...
-- =================================================
               twbkfrmt.p_tabledata (
                  twbkfrmt.F_FormHidden ('start_date_in', 'NR') ||
                     g$_nls.get ('BWCKCOM1-0131', 'SQL', 'Not available')
               );
               twbkfrmt.p_tabledata (
            ...
            twbkfrmt.p_tabledata (
               twbkfrmt.F_FormHidden (
                  ...
                  g$_nls.get ('BWCKCOM1-0133', 'SQL', ' to ') ||
                  twbkfrmt.F_FormHidden (
                     'start_date_to_in',
                     TO_CHAR (
                        local_ssbsect_row.ssbsect_learner_regstart_tdate,
...
-- =================================================
   HTP.br;
   HTP.formsubmit (NULL, g$_nls.get ('BWCKCOM1-0135', 'SQL', 'Submit Changes'));
  --C3SC GR, 06/18/2006, ADDED
    IF  sv_auth_addcodes_bp.f_is_auth_enabled(p_term_code  => term)
    THEN
      HTP.formsubmit ('REG_BTN', g$_nls.get ('BWCKCOM1-0136', 'SQL', 'Cancel'));
    END IF;
   --END C3SC
   HTP.formclose;
   twbkwbis.p_closedoc (curr_release);
...
--C3SC 24/02/2006 GRS
  ...
  lv_cancel             VARCHAR2(50):= g$_nls.get ('BWCKCOM1-0137', 'SQL', 'Cancel');
  --C3SC 24/02/2006 GRS
...
--------------------------------------------------------------------------
   ...
   IS
     ...
     --FHDA Mod 12/05/2012
     --Function to see if census_enrl_date has not reached -- passed
     function f_census_date_passed(f_term varchar2, f_crn varchar2) return boolean is
       
       cursor census_date_c is
         select ct.ssbsect_census_enrl_date
         from ssbsect ct
         where ct.ssbsect_term_code = f_term
         and   ct.ssbsect_crn = f_crn;
       
       lv_census_date date;
       lv_passed boolean default false;
       
     begin
       
       open census_date_c;
       fetch census_date_c into lv_census_date;
       close census_date_c;
       
      if trunc(sysdate) >= lv_census_date then        
        lv_passed := true;      
      else        
        lv_passed := false;        
      end if;
...
-- ==================================================
        ...
        --C3SC STU32 ADDED  GRS 08/04/2006
         ...
         -- FHDA Mod 11/19/2012
         -- FHDA MOD 01/22/2013 - switch from 'DW' RSTS_code to 'DG' 
         -- If the rsts code is for drop, make sure the class to be dropped is not part of the 
         -- 3rd time drop prevention. If it indeed is, do not display the drop option.
         if active_web_drop= 'Y' and  -- web drop allowed
            rsts_row.stvrsts_code ='DG' and   --- rsts code indicates a drop 
            f_subg_crse_selected(pidm_in, term_in, crn_in ) and-- class already has two prior substandard grades.            
            f_census_date_passed(term_in, crn_in)-- 12/4/2012 - need to add logic here to allow drops to occur before the census date of the CRN
...
-- ==================================================
         ...
         THEN
            twbkfrmt.p_tabledataopen;
            twbkfrmt.p_formlabel (
               g$_nls.get ('BWCKCOM1-0138', 'SQL', 'Action'),
               visible   => 'INVISIBLE',
            ...
            THEN
               twbkwbis.p_formselectoption (
                  g$_nls.get ('BWCKCOM1-0139', 'SQL', 'None'),
                  NULL,
                  'SELECTED'
               );
            ELSE
        ...
        --C3SC STU32 ADDED  GRS 08/04/2006
         IF active_web_drop ='Y' THEN
           ...
           THEN
             twbkfrmt.p_tabledataopen;
             twbkfrmt.p_formlabel (
               g$_nls.get ('BWCKCOM1-0141', 'SQL', 'Action'),
               visible   => 'INVISIBLE',
               idname    => 'action_id' || TO_CHAR (regs_count_in)
               );
              HTP.formselectopen (
             ...
             THEN
               twbkwbis.p_formselectoption (
                  g$_nls.get ('BWCKCOM1-0142', 'SQL', 'None'),
                  NULL,
                  'SELECTED'
               );
             ELSE
...
-- ===============================================================
         ...
         THEN
            twbkfrmt.p_tabledataopen;
            twbkfrmt.p_formlabel (
               g$_nls.get ('BWCKCOM1-0144', 'SQL', 'Action'),
               visible   => 'INVISIBLE',
            ...
            THEN
               twbkwbis.p_formselectoption (
                  g$_nls.get ('BWCKCOM1-0145', 'SQL', 'None'),
                  NULL,
                  'SELECTED'
               );
            ELSE
...
-- 8.5.1.1
      IF row_count_out = 0
         THEN
            twbkfrmt.p_tabledataopen;
            twbkfrmt.p_formlabel (
               g$_nls.get ('BWCKCOM1-0147', 'SQL', 'Action'),
               visible   => 'INVISIBLE',
               idname    => 'waitaction_id' || TO_CHAR (wait_count_in)
            );
            HTP.formselectopen (
            ...
            twbkwbis.p_formselectoption (
                  g$_nls.get ('BWCKCOM1-0148', 'SQL', 'None'),
                  NULL,
                  'SELECTED'
               );
      END IF;
...
-- ==================================================
   ...
   twbkfrmt.p_tableopen (
      ...
      cattributes   => 'SUMMARY="' ||
                          g$_nls.get ('BWCKCOM1-0149',
                             ...
                             'Class Connections') ||
                          '"',
      ccaption      => g$_nls.get ('BWCKCOM1-0150', 'SQL',
   ...
   THEN
      twbkfrmt.p_tabledataheader (
         g$_nls.get ('BWCKCOM1-0151', 'SQL', 'Associated Term')
      );
   END IF;
   ...
   twbkfrmt.p_tabledataheader (
      twbkfrmt.f_printtext (
         '<ACRONYM title = "' ||
            g$_nls.get ('BWCKCOM1-0152', 'SQL', 'Course Reference Number') || '">' ||
            g$_nls.get ('BWCKCOM1-0153', 'SQL', 'CRN') ||
            '</ACRONYM>'
      )
   );
   twbkfrmt.p_tabledataheader (
      twbkfrmt.f_printtext (
         '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0154', 'SQL', 'Subject') ||
         '>' || g$_nls.get ('BWCKCOM1-0155', 'SQL', 'Subj') ||
            '</ABBR>'
      )
   );
   twbkfrmt.p_tabledataheader (
      twbkfrmt.f_printtext (
         '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0156', 'SQL', 'Course') || '>' ||
         g$_nls.get ('BWCKCOM1-0157', 'SQL', 'Crse') ||
            '</ABBR>'
      )
   );
   twbkfrmt.p_tabledataheader (
      twbkfrmt.f_printtext (
         '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0158', 'SQL', 'Section') ||
         '>' || g$_nls.get ('BWCKCOM1-0159', 'SQL', 'Sec') ||
            '</ABBR>'
      )
   );
   twbkfrmt.p_tabledataheader (g$_nls.get ('BWCKCOM1-0160', 'SQL', 'Title'));

   twbkfrmt.p_tabledataheader (g$_nls.get ('BWCKCOM1-0161', 'SQL', 'Registration Issues'));
...
-- =================================================
   HTP.br;
   HTP.formsubmit ('submit_btn', g$_nls.get ('BWCKCOM1-0162', 'SQL', 'Drop'));
   HTP.formsubmit ('submit_btn', g$_nls.get ('BWCKCOM1-0163', 'SQL', 'Do not drop'));
   HTP.formclose;
   HTP.br;
...
-- =====================================================================
   lv_literal := g$_nls.get ('BWCKCOM1-0164', 'SQL', 'Drop');
...
BEGIN
    ...
    twbkfrmt.p_printmessage (
       g$_nls.get ('BWCKCOM1-0165', 'SQL', 'Registration Update Errors'),
       'ERROR'
    );
   ...
   THEN
      twbkfrmt.p_tabledataheader (
         g$_nls.get ('BWCKCOM1-0167', 'SQL', 'Associated Term')
      );
   END IF;
   ...
   twbkfrmt.p_tabledataheader (
      twbkfrmt.f_printtext (
         '<ACRONYM title = "' ||
            g$_nls.get ('BWCKCOM1-0168', 'SQL', 'Course Reference Number') ||
            '">' ||
            g$_nls.get ('BWCKCOM1-0169', 'SQL', 'CRN') ||
            '</ACRONYM>'
      )
   );
   twbkfrmt.p_tabledataheader (
      twbkfrmt.f_printtext (
         '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0170', 'SQL', 'Subject') ||
         '>' || g$_nls.get ('BWCKCOM1-0171', 'SQL', 'Subj') ||
            '</ABBR>'
      )
   );
   twbkfrmt.p_tabledataheader (
      twbkfrmt.f_printtext (
         '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0172', 'SQL', 'Course') ||
         '>' || g$_nls.get ('BWCKCOM1-0173', 'SQL', 'Crse') ||
            '</ABBR>'
      )
   );
   twbkfrmt.p_tabledataheader (
      twbkfrmt.f_printtext (
         '<ABBR title = ' || g$_nls.get ('BWCKCOM1-0174', 'SQL', 'Section') ||
         '>' || g$_nls.get ('BWCKCOM1-0175', 'SQL', 'Sec') ||
            '</ABBR>'
      )
   );
   twbkfrmt.p_tabledataheader (g$_nls.get ('BWCKCOM1-0176', 'SQL', 'Status'));
   twbkfrmt.p_tablerowclose;
...
-- Store the parameter values for use in next page
      ...
      twbkfrmt.p_formlabel(g$_nls.get('BWCKCOM1-0178',
                                      'SQL',
                                      'Select a Study Path:'));
      ...
      twbkwbis.P_FormSelectOption(G$_NLS.Get('BWCKCOM1-0179',
                                             'SQL',
                                             'None'),
                                  NULL);
    END IF;
  ...
  twbkfrmt.p_tablerowclose;
  twbkfrmt.P_TableClose;
  HTP.formsubmit(NULL, G$_NLS.Get('BWCKCOM1-0180', 'SQL', 'Submit'));
...
BEGIN
      ...
      IF print_header THEN
        ...
        LOOP
          ...
          END IF;
            ...
            twbkfrmt.p_formlabel(g$_nls.get('BWCKCOM1-0182',
                                            'SQL',
                                            'Select a Study Path:'));
            ...
            IF msg IS NOT NULL THEN
              IF twbkwbis.f_getparam(global_pidm, 'G_SP' || old_term) =
                 'NULL' THEN
                twbkwbis.p_formselectoption(g$_nls.get('BWCKCOM1-0183',
                                                       'SQL',
                                                       'None'),
                                            '|' || old_term,
                                            'SELECTED');
        ...
        IF row_count = 0 THEN
            ...
            ELSE
                ...
                twbkfrmt.p_formlabel(g$_nls.get('BWCKCOM1-0187',
                                                'SQL',
                                                'Select a Study Path:'));
                htp.formselectopen('p_st_path',
                                   NULL,
                                   1,
                                   cattributes => 'ID="st_path_id"');
                twbkwbis.p_formselectoption(g$_nls.get('BWCKCOM1-0188',
                                                     'SQL',
                                                     'None'),
                                                     '|' || old_term);
            END IF;
        ...
        twbkfrmt.p_tablerowopen;
                        ...
                        cvalue =>twbkfrmt.f_printtext (
                           '<ACRONYM title = "' ||
                              g$_nls.get ('BWCKCOM1-0190',
                                 ...
                                 'Course Reference Number') ||
                              '">' ||
                              g$_nls.get ('BWCKCOM1-0191', 'SQL', 'CRN') ||
                              '</ACRONYM>'
                        ),
                     ...
                     twbkfrmt.p_tabledataheader (
                        cvalue =>twbkfrmt.f_printtext (
                           '<ABBR title = ' ||
                              g$_nls.get ('BWCKCOM1-0192', 'SQL', 'Subject') ||
                              '>' ||
                              g$_nls.get ('BWCKCOM1-0193', 'SQL', 'Subj') ||
                              '</ABBR>'
                        ),
                        cattributes =>'WIDTH="10%"'
                     );
                     twbkfrmt.p_tabledataheader (
                        cvalue =>twbkfrmt.f_printtext (
                           '<ABBR title = ' ||
                              g$_nls.get ('BWCKCOM1-0194', 'SQL', 'Course') ||
                              '>' ||
                              g$_nls.get ('BWCKCOM1-0195', 'SQL', 'Crse') ||
                              '</ABBR>'
                        ),
                        cattributes =>'WIDTH="10%"'
                     );
                     twbkfrmt.p_tabledataheader (
                        cvalue =>twbkfrmt.f_printtext (
                           '<ABBR title = ' ||
                              g$_nls.get ('BWCKCOM1-0196', 'SQL', 'Section') ||
                              '>' ||
                              g$_nls.get ('BWCKCOM1-0197', 'SQL', 'Sec') ||
                              '</ABBR>'
                        ),
                        cattributes =>'WIDTH="10%"'
                     );
                     twbkfrmt.p_tabledataheader (
                        cvalue =>twbkfrmt.f_printtext (
                           '<ABBR title = ' ||
                              g$_nls.get ('BWCKCOM1-0198', 'SQL', 'Campus') ||
                              '>' ||
                              g$_nls.get ('BWCKCOM1-0199', 'SQL', 'Cmp') ||
                              '</ABBR>'
                        ),
                        cattributes =>'WIDTH="10%"'
                     );
                     twbkfrmt.p_tabledataheader (
                        cvalue =>twbkfrmt.f_printtext (
                           '<ABBR title = "' ||
                              g$_nls.get ('BWCKCOM1-0200',
                                 'SQL',
                                 'Credit Hours') ||
                              '">' ||
                              g$_nls.get ('BWCKCOM1-0201', 'SQL', 'Cred') ||
                              '</ABBR>'
                        ),
                        cattributes =>'WIDTH="20%"'
                     );
                     twbkfrmt.p_tabledataheader (
                        cvalue =>g$_nls.get ('BWCKCOM1-0202', 'SQL', 'Title'),
  ...
  HTP.BR;
    ...
    htp.formsubmit('REG_BTN', g$_nls.get('BWCKCOM1-0203', 'SQL', 'Register'));

  HTP.formsubmit (
            'REG_BTN',
            g$_nls.get ('BWCKCOM1-0204', 'SQL', 'Class Search')
         );
  HTP.BR;
  htp.formclose;
  twbkwbis.p_closedoc (curr_release);
...
BEGIN
  ...
  lv_literal := g$_nls.get ('BWCKCOM1-0205',
                   'SQL',
                   'Class Search');
  IF LTRIM (RTRIM (reg_btn (2))) = lv_literal
  THEN
...
--- FHDA Mod Begin  08/18/2012
--- Function that determines if a student is registering a class that he already has two prior
--- sub grades
--- Fill in the details later, for now just return true.
...
procedure p_disp_warning_confirm (
        term_in         IN   OWA_UTIL.ident_arr,
        rsts_in         IN   OWA_UTIL.ident_arr,
        assoc_term_in   IN   OWA_UTIL.ident_arr,
        crn_in          IN   OWA_UTIL.ident_arr,
        ...
        next_proc_in    IN   VARCHAR2,
        msg_in          in   varchar2 default null,
        subg_term       IN   OWA_UTIL.ident_arr,
        subg_crn        in   owa_util.ident_arr,
        subg_subj       in   owa_util.ident_arr,
        subg_crse       in   owa_util.ident_arr,
        subg_sec        in   owa_util.ident_arr) is
...
-- End C3SC, 03/29/06
    ...
    twbkwbis.p_dispinfo ('bwckcoms.p_disp_warning_confirm');
...
-- ==================================================
   htp.formopen (
      twbkwbis.f_cgibin || 'bwckcoms.p_proc_warning_confirm',
      cattributes   => 'onSubmit="return checkSubmit()"'
   );
   ...
   --htp.p('regs_row is '|| regs_row|| ' '|| reg_btn (1)||' '|| reg_btn (2) ||' crn_in  count is '||crn_in.count ||' subg_crn count is '||subg_crn.count);

   --- display classes that have two prior sub standard grades
    for f in 2 .. subg_crn.count loop
      exit when subg_crn (f) is null;
      ...
      IF f = 2  THEN
         twbkfrmt.p_tableopen (
            ...
            cattributes =>
               'WIDTH="75%" SUMMARY="' ||
               g$_nls.get ('BWCKCOM1-0116',
                           'SQL',
                           'This table allows the user to confirm warning on a class being registered.') ||
               '."'
         );
         twbkfrmt.p_tablerowopen;
         twbkfrmt.p_tabledataheader (
            twbkfrmt.f_printtext (
               '<ACRONYM title = "' ||
                  g$_nls.get ('BWCKCOM1-0117', 'SQL', 'Course Reference Number') ||
                  '">' ||
                  g$_nls.get ('BWCKCOM1-0118', 'SQL', 'CRN') ||
                  '</ACRONYM>'
            )
         );
         ...
         IF multi_term  THEN
            twbkfrmt.p_tabledataheader (
               g$_nls.get ('BWCKCOM1-0119', 'SQL', 'Associated Term')
            );
         END IF;

         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0120', 'SQL', 'Course')
         );
         twbkfrmt.p_tabledataheader (
            g$_nls.get ('BWCKCOM1-0121', 'SQL', 'Course Title')
         );
      ...
      twbkfrmt.p_tablerowopen;
      twbkfrmt.p_tabledata (subg_crn(f));

      IF multi_term  then
            twbkfrmt.p_tabledata (bwcklibs.f_term_desc(subg_term(f)));
      END IF;

      twbkfrmt.p_tabledata (subg_subj(f)||' '||subg_crse(f) );
      twbkfrmt.p_tabledata (bwcklibs.f_course_title (subg_term(f), subg_crn(f)));

      twbkfrmt.p_tablerowclose;

   end loop;

   IF subg_crn.COUNT > 1 THEN
      twbkfrmt.p_tableclose;
   end if;

   -- populate hidden fields to be carried over to the next transaction
...
-- =================================================
   HTP.br;
   HTP.formsubmit ('REG_BTN', g$_nls.get ('BWCKCOM1-1133', 'SQL', 'Confirm'));
  --C3SC GR, 06/18/2006, ADDED
    IF  sv_auth_addcodes_bp.f_is_auth_enabled(p_term_code  => term)
    THEN
      HTP.formsubmit ('REG_BTN', g$_nls.get ('x', 'SQL', 'Cancel'));
    END IF;
   --END C3SC
    HTP.formclose;
   twbkwbis.p_closedoc (curr_release);
...
procedure p_proc_warning_confirm (
      term_in              IN   OWA_UTIL.ident_arr,
      rsts_in              IN   OWA_UTIL.ident_arr,
      assoc_term_in        IN   OWA_UTIL.ident_arr,
      crn_in               IN   OWA_UTIL.ident_arr,
      ...
      lv_confirm           varchar2(15);
      lv_cancel            varchar2(15);
      lv_reg_warning       constant varchar2(10) := 'prev2subg';
      term                stvterm.stvterm_code%TYPE := NULL;
      multi_term           boolean                   := true;
...
--
   lv_confirm := g$_nls.get ('BWCKCOM1-2196',
                   'SQL',
                   'Confirm');

   lv_cancel := g$_nls.get ('BWCKCOM1-2197',
                   'SQL',
                   'Cancel');

   if ltrim (rtrim (reg_btn (4))) = lv_confirm then  -- user confirmed

     twbkwbis.p_setparam(global_pidm, lv_reg_warning,'Y');

   elsif ltrim (rtrim (reg_btn (4))) = lv_cancel then -- user cancelled
      ...
      --- delete the twgrwprm entry for this transaction to
         ...
         begin
            delete from twgrwprm m
            where m.twgrwprm_pidm = genpidm
            and m.twgrwprm_param_name= lv_reg_warning;
