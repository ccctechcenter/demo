...
-- PRODUCT....: CALB
-- COPYRIGHT..: Copyright 1996-2015 Ellucian Company L.P. and its affiliates. 
--
...
/* LOCAL01 commented out this error
         IF    stvrsts_row.stvrsts_incl_sect_enrl = 'Y'
...
*/
         ...
         END IF;
 --LOCAL02  Log drops to a holding table. Moved from bwcklib1 
        pw_register.p_szrptcn_Insert(term,
                          genpidm,
                          crn,
                          rsts,
                          '');
      ...
      IF     NVL (sftregs_row.sftregs_error_flag, 'X') <> 'D' THEN
        ...
        ELSE     
            ...
            degree_severity   :=    'N' ;
             ...
             atts_severity    :=    'N' ;
              chrt_severity   :=    'N' ;
             -- C3SC 8.4 GRS 10/22/2010 Modified
             --capc_severity    :=    sobterm_row.sobterm_capc_severity;
             capc_severity:= sv_auth_addcodes_bp.F_set_capacity_value(p_term_code =>sftregs_row.sftregs_term_code,
                                                 p_pidm =>     sftregs_row.sftregs_pidm,
                                                 p_rsts_code =>sftregs_row.sftregs_rsts_code,
...
-- C3SC, GR 19/02/06, Added 
-- bypass AUTH REQD errors if override flag is O
--  htp.p('sftregs_errror_flag=>'||sftregs_row.sftregs_error_flag);
  --htp.p('sftregs_errror_flag=>'||sftregs_row.sftregs_message);
...
--LOCAL02  Log drops to a holding table. Moved from bwcklib1 
IF     NVL (sftregs_row.sftregs_error_flag, 'X') = 'D'
         or NVL (sftregs_row.sftregs_vr_status_type,'X')  IN ('D', 'W') 
THEN
        pw_register.p_szrptcn_Insert(sftregs_row.sftregs_term_code,
                          sftregs_row.sftregs_pidm,
                          sftregs_row.sftregs_crn,
                          sftregs_row.sftregs_rsts_code,
                          '');
end if;
