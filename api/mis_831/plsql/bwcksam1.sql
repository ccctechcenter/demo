...
-- <<Coast>> -- start changes TRvvvv 9/30/2015
         OPEN part_of_term_desc_c(sftregs_row.rec_sftregs_term_code, sftregs_row.rec_ssbsect_ptrm_code);
         FETCH part_of_term_desc_c INTO part_of_term_description, part_of_term_start, part_of_term_end;
         CLOSE part_of_term_desc_c;
         twbkfrmt.p_tabledata (part_of_term_description);
         twbkfrmt.p_tabledata (TO_CHAR(part_of_term_start, 'Mon DD')
                || ' - ' || TO_CHAR(part_of_term_end, 'Mon DD'));
-- <<Coast>> -- end changes TR^^^^
...
--          Add Part of Term title and Dates
         OPEN part_of_term_desc_c(sftregs_row.rec_sftregs_term_code, sftregs_row.rec_ssbsect_ptrm_code);
         FETCH part_of_term_desc_c INTO part_of_term_description, part_of_term_start, part_of_term_end;
         CLOSE part_of_term_desc_c;
         twbkfrmt.p_tabledata (part_of_term_description);
