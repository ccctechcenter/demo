...
create or replace package baninst1.bzccreg as

PROCEDURE ADD_OR_DROP(term VARCHAR2,
                      rsts STVRSTS.STVRSTS_CODE%TYPE,
                      pidm NUMBER,
                      crn  VARCHAR2);
...
create or replace package body baninst1.bzccreg as
...
/
set define on;
create public synonym BZCCREG FOR BANINST1.BZCCREG;
/
grant execute on BZCCREG to &ADAPTOR_USER;
/
